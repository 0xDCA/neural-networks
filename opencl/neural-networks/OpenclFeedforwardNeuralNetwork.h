#ifndef OPENCLFEEDFORWARDNEURALNETWORK_H_
#define OPENCLFEEDFORWARDNEURALNETWORK_H_
...
class OpenclFeedforwardNeuralNetwork : public FeedforwardNeuralNetwork {
public:
    OpenclFeedforwardNeuralNetwork(const std::vector<int>& layer_neurons);
...
private:
    ...
    OpenclNeuralNetworkHelper opencl_helper;
...
#endif /* OPENCLFEEDFORWARDNEURALNETWORK_H_ */
