#ifndef OPENMPIFEEDFORWARDNEURALNETWORK_H
#define OPENMPIFEEDFORWARDNEURALNETWORK_H
...
class OpenmpiFeedforwardNeuralNetwork : public FeedforwardNeuralNetwork {
public:
    OpenmpiFeedforwardNeuralNetwork(const std::vector<int>& layers);
...
#endif //OPENMPIFEEDFORWARDNEURALNETWORK_H
